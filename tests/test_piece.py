...
class TestPiece:
    ...
    def test_pawn_moves(self):
        self.setup_method()
        self.game.place_piece_manually(
            Pawn("White", (6, 6)), (6, 6)
        )  # White pawn on g2
        self.game.place_piece_manually(
            Pawn("Black", (5, 7)), (5, 7)
        ...
        assert (
            len(notation_list) == 2
        ), "Incorrect number of pawn moves generated (en passant scenario)"
        assert set(notation_list) == set(
            expected
        ), "Wrong pawn moves generated (en passant scenario)"
        ...
        assert (
            len(notation_list) == 8
        ), "Incorrect number of pawn moves generated (promotion scenario)"
        assert set(notation_list) == set(
            expected
        ), "Wrong pawn moves generated (promotion scenario)"
